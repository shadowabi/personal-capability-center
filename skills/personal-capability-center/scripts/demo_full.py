"""
Personal Capability Center System - 完整功能演示
演示所有核心功能的使用
"""
...
def demonstrate_search_functions():
    ...
    try:
        ...
        for idx, (conv_id, title, summary, tags, importance, conv_date) in enumerate(
            python_convos, 1
        ):
            print(f"  {idx}. ID:{conv_id} | {title}")
            print(f"     摘要: {summary}")
        ...
        for idx, (conv_id, title, summary, importance, conv_date) in enumerate(
            important_convos, 1
        ):
        ...
        print("\n2.4 关键词搜索")
        print("-" * 70)
        keyword_results = memory.search_by_keyword(
            "学习", search_in_details=True, limit=5
        )
...
def demonstrate_advanced_features():
    ...
    try:
        ...
        high_importance_similar = memory.search_similar(
            generate_mock_embedding(), limit=3, min_importance=7
        )
        ...
        for idx, (
            ...
            importance,
            similarity,
        ) in enumerate(high_importance_similar, 1):
...
def main():
    """运行所有演示"""
    print("\n" + "=" * 70)
    print(" Personal Capability Center System - 完整功能演示")
    print("=" * 70 + "\n")

    print("\n本演示将展示个人能力中心系统的所有核心功能：")
    print("  1. 添加对话到个人能力中心")
    ...
    if success_count == total_count:
        print("\n" + "=" * 70)
        print("  恭喜！所有功能演示完成！")
        print("  Personal Capability Center System 运行正常！")
        print("=" * 70 + "\n")
    else:
        print("\n部分演示失败，请检查错误信息。")
